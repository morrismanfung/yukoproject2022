...
# SVC Training
02-model/01-saved-model/02-pipe_svc_opt.joblib 02-model/02-saved-scores/02-svc_dict_tmp.pkl 02-model/02-saved-scores/02-svc-pr-curve.png: \
...
# RFC Training
02-model/01-saved-model/03-pipe_rfc_opt.joblib 02-model/02-saved-scores/03-rfc_dict_tmp.pkl 02-model/02-saved-scores/03-rfc-pr-curve.png: \
...
# NB Training
02-model/01-saved-model/04-pipe_nb.joblib 02-model/02-saved-scores/04-nb_dict_tmp.pkl 02-model/02-saved-scores/04-nb-pr-curve.png: \
...
# LogReg Training
02-model/01-saved-model/05-pipe_logreg_opt.joblib 02-model/02-saved-scores/05-logreg_dict_tmp.pkl 02-model/02-saved-scores/05-logreg-pr-curve.png: \
...
# LSVC Training
02-model/01-saved-model/06-pipe_lsvc_opt.joblib 02-model/02-saved-scores/06-lsvc_dict_tmp.pkl 02-model/02-saved-scores/06-lsvc-pr-curve.png: \
...
# All Results
02-model/02-saved-scores/07-cross-validation-results.csv 02-model/02-saved-scores/08-test-results.csv: \
