...
def main():
    ...
    nb_dict = load( '02-model/02-saved-scores/04-nb_dict_tmp.joblib')

    nb_dict[ 'test_scores'] = model_testing( pipe_nb, X_train, y_train, X_test, y_test)
...
def model_testing( pipe_nb, X_train, y_train, X_test, y_test):
